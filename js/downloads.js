...
var backgroundMap = (function(){
    var obj = [
        {path: "rooster island 2/level6.map", x: 130, y: 196},  // castle of clocks
        {path: "rooster island 1/level005.map", x: 73, y: 204}, // castle of towers
        {path: "rooster island 1/level010.map", x: 156, y: 100} // teleport castle
    ];
    return obj[Math.floor(Math.random() * obj.length)];
})();

$(document).ready(function(){
    $("body").load("/downloads/body.html", function(){
        ...
        //     $("section:not(.active)").css("display", "none");
        // }
        if ($("title").html() === "Episode Database") {
            sectionLinkActivation("episodeDB", "Episode Database");
        } else if ($("title").html() === "Resource Database") {
             sectionLinkActivation("resourceDB", "Resource Database");
        } else {
            $("section:not(.active)").css("display", "none");
        }
